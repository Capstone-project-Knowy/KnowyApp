...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playAnimation(){
        ...
        val passwordEdit = ObjectAnimator.ofFloat(binding.tilPassword, View.ALPHA, 1f).setDuration(500)
        val btnLogin = ObjectAnimator.ofFloat(binding.btnLogin, View.ALPHA, 1f).setDuration(500)
        val notAccount = ObjectAnimator.ofFloat(binding.tvNotHaveAccount, View.ALPHA, 1f).setDuration(500)
